...
function criarTarefaAfazer(nomeTarefa) { // -> Funcao para mostrar a tarefa na tela
  ...
  div.innerHTML = `
    <div class="task-nome">
      <img src="./image/waiting.png" alt="Icone de um circulo com 3 pontos">
      <p class="nome-tarefa">${nomeTarefa}</p>
    </div>

    <div class="task-acoes">
      <button>
        <img src="./image/time.png" alt="Icone de um relogio com seta pra cima">
      </button>

      <button class="botao-excluir">
        <img src="./image/lixeira.png" alt="Icone de uma lixeira">
      </button>
    </div>
  `
